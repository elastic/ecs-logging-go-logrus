[![Build Status](https://github.com/elastic/ecs-logging-go-logrus/actions/workflows/test.yml/badge.svg)](https://github.com/elastic/ecs-logging-go-logrus/actions/workflows/test.yml)
